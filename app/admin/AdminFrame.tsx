 ...
 * (banner, rail, category drawer) in the clinic's own branding, the
 * clinic's name, the row of section links, and then the page's own title
 * and content.
 *
 ...
 *
 * It takes the clinic the page already fetched (requireClinicPage), so the
 * branding costs no extra read.
 *
