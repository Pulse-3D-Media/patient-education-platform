...
export default async function PeoplePage() {
  ...
  return (
    <AdminFrame
      ...
      intro={
        <>
          Everyone who can sign in to {clinic.name}. Surgeons are what your clinic pays for; staff are free. Neither changes
          what a person can do: that is their role, set in the panel further down.
        </>
      }
    >
