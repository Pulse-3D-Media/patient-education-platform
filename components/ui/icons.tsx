...
export function ShareIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true">
      <path d="M8 9.5H6.5A1.5 1.5 0 0 0 5 11v8.5A1.5 1.5 0 0 0 6.5 21h11a1.5 1.5 0 0 0 1.5-1.5V11a1.5 1.5 0 0 0-1.5-1.5H16" />
      <path d="M12 15V3" />
...
/** Four tiles, one lifted: the clinic admin symbol. The rail link to the admin area (overview, shared links, people, billing). */
...
/** A clock face: how long the video runs, and a link that has run out of time. */
...
/** A telephone handset: the tap-to-call link on the patient page. */
